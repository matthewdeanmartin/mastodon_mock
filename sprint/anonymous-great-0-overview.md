...
| 2 | `anonymous-great-2-clone-friends.md` | Profile `•••` menu reorder; clone the viewed account's follows into `AnonymousFollows` | PLANNED | The bulk-follow blast radius, contained by decision 3 (anonymous-only, zero writes) |
